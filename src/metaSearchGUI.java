...
// NOTE: This GUI is non-functional, its key purpose is "desgin" ONLY
...
//Class program to create GUI: sets dimensions, add functions [To be Added] and more
...
public class metaSearchGUI extends JFrame                                          // Consturctor for main class, sub class of JFrame
{
    ...
    //Inner Class for action listener, adds functionality to buttons and more [To be Added]
